        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    typedArrayObtainAttributes = android.support.v4.a.a.c.a(resources, theme, attributeSet, android.support.b.a.a.e);
                    int resourceId = typedArrayObtainAttributes.getResourceId(0, 0);
                    if (resourceId != 0) {
                        i iVarA = i.a(resources, resourceId, theme);
                        iVarA.a(false);
                        iVarA.setCallback(this.a);
                        if (this.c.b != null) {
                    ...
                    typedArrayObtainAttributes = resources.obtainAttributes(attributeSet, android.support.b.a.a.f);
