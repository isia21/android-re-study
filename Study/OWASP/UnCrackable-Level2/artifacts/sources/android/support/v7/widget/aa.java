...
class aa extends z {
    ...
    void a(AttributeSet attributeSet, int i) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(a.j.AppCompatTextHelper_android_drawableStart)) {
            this.b = a(context, lVarA, typedArrayObtainStyledAttributes.getResourceId(a.j.AppCompatTextHelper_android_drawableStart, 0));
        }
        if (typedArrayObtainStyledAttributes.hasValue(a.j.AppCompatTextHelper_android_drawableEnd)) {
            this.c = a(context, lVarA, typedArrayObtainStyledAttributes.getResourceId(a.j.AppCompatTextHelper_android_drawableEnd, 0));
        }
