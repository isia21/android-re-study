...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.b = typedArrayObtainStyledAttributes.getDimensionPixelOffset(a.j.RecycleListView_paddingBottomNoButtons, -1);
            this.a = typedArrayObtainStyledAttributes.getDimensionPixelOffset(a.j.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, k kVar, Window window) {
        ...
        this.r = window;
        this.p = new b(kVar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, a.j.AlertDialog, a.C0011a.alertDialogStyle, 0);
    ...
    private void a(ViewGroup viewGroup) {
        View viewInflate = this.v != null ? this.v : this.w != 0 ? LayoutInflater.from(this.q).inflate(this.w, viewGroup, false) : null;
    ...
    private void c() {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById10 = (this.u == null && this.b == null) ? null : viewGroupA.findViewById(a.f.titleDividerNoCustom);
