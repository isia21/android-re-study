...
public class ActionBarOverlayLayout extends ViewGroup implements android.support.v4.g.k, ad {
    static final int[] e = {a.C0011a.actionBarSize, R.attr.windowContentOverlay};
    ...
    protected boolean fitSystemWindows(Rect rect) {
        c();
        int iF = android.support.v4.g.p.f(this) & 256;
        boolean zA = a(this.a, rect, true, true, false, true);
        this.t.set(rect);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMax = Math.max(0, this.a.getMeasuredWidth() + bVar.leftMargin + bVar.rightMargin);
        int iMax2 = Math.max(0, this.a.getMeasuredHeight() + bVar.topMargin + bVar.bottomMargin);
