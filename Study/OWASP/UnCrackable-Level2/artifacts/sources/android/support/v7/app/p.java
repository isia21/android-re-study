...
public class p extends android.support.v7.app.a implements ActionBarOverlayLayout.a {
    ...
    private void a(View view) {
        ...
        android.support.v7.view.a aVarA = android.support.v7.view.a.a(this.a);
        a(aVarA.f() || z);
        k(aVarA.d());
        TypedArray typedArrayObtainStyledAttributes = this.a.obtainStyledAttributes(null, a.j.ActionBar, a.C0011a.actionBarStyle, 0);
    ...
    public void h(boolean z) {
        ...
        if (this.E == 0 && (this.H || z)) {
            ...
            s sVarB = android.support.v4.g.p.d(this.c).b(0.0f);
            sVarB.a(this.r);
            hVar.a(sVarB);
    ...
    public void i(boolean z) {
        ...
        s sVarB = android.support.v4.g.p.d(this.c).b(f);
        sVarB.a(this.r);
        hVar.a(sVarB);
        if (this.k && this.f != null) {
    ...
    public void j(boolean z) {
        ...
        if (z) {
            sVarA2 = this.d.a(4, 100L);
            sVarA = this.e.a(0, 200L);
        } else {
            sVarA = this.d.a(0, 200L);
            sVarA2 = this.e.a(8, 100L);
        }
        android.support.v7.view.h hVar = new android.support.v7.view.h();
        hVar.a(sVarA2, sVarA);
        hVar.a();
