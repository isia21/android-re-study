...
public final class l {
    ...
    private static class b extends android.support.v4.f.g<Integer, PorterDuffColorFilter> {
        public b(int i) {
            super(i);
        }
    ...
    private Drawable a(Context context, int i2, boolean z, Drawable drawable) {
        ...
        if (colorStateListB != null) {
            ...
            Drawable drawableF = android.support.v4.b.a.a.f(drawable);
            android.support.v4.b.a.a.a(drawableF, colorStateListB);
            PorterDuff.Mode modeA = a(i2);
            if (modeA == null) {
                return drawableF;
            }
            android.support.v4.b.a.a.a(drawableF, modeA);
            return drawableF;
        }
        if (i2 == a.e.abc_seekbar_track_material) {
            layerDrawable = (LayerDrawable) drawable;
            a(layerDrawable.findDrawableByLayerId(R.id.background), ar.a(context, a.C0011a.colorControlNormal), a);
            ...
            layerDrawable = (LayerDrawable) drawable;
            a(layerDrawable.findDrawableByLayerId(R.id.background), ar.c(context, a.C0011a.colorControlNormal), a);
            drawableFindDrawableByLayerId = layerDrawable.findDrawableByLayerId(R.id.secondaryProgress);
            i3 = a.C0011a.colorControlActivated;
        }
        a(drawableFindDrawableByLayerId, ar.a(context, i3), a);
        a(layerDrawable.findDrawableByLayerId(R.id.progress), ar.a(context, a.C0011a.colorControlActivated), a);
        return drawable;
    }
    ...
    */
    ...
    private ColorStateList e(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList colorStateListB = ar.b(context, a.C0011a.colorSwitchThumbNormal);
    ...
    private ColorStateList f(Context context, int i2) {
        int iA = ar.a(context, a.C0011a.colorControlHighlight);
        return new ColorStateList(new int[][]{ar.a, ar.d, ar.b, ar.h}, new int[]{ar.c(context, a.C0011a.colorButtonNormal), android.support.v4.b.a.a(iA, i2), android.support.v4.b.a.a(iA, i2), i2});
    }
    ...
    Drawable a(Context context, int i2, boolean z) {
        ...
        if (drawableD == null) {
            drawableD = android.support.v4.a.a.a(context, i2);
        }
        if (drawableD != null) {
    ...
    Drawable a(Context context, bb bbVar, int i2) {
        Drawable drawableD = d(context, i2);
        if (drawableD == null) {
            drawableD = bbVar.a(i2);
        }
        if (drawableD != null) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    android.content.res.ColorStateList b(android.content.Context r3, int r4) {
        /*
            r2 = this;
