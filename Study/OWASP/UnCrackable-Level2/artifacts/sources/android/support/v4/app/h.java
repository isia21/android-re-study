...
public class h extends f {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        int i3 = i >> 16;
        if (i3 == 0) {
            a.InterfaceC0004a interfaceC0004aA = android.support.v4.app.a.a();
            if (interfaceC0004aA == null || !interfaceC0004aA.a(this, i, i2, intent)) {
        ...
        g gVarA = this.d.a(strA);
        if (gVarA != null) {
            gVarA.a(i & 65535, i2, intent);
            return;
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        Object objC = c();
        n nVarD = this.d.d();
        if (nVarD == null && this.m == null && objC == null) {
            return null;
        }
        b bVar = new b();
        bVar.a = objC;
