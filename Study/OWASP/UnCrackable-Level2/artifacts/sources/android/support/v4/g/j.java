...
public class j {
    ...
    public boolean a(float f, float f2) {
        ...
        return r.a(viewParentD, this.c, f, f2);
    }
    ...
    public boolean a(float f, float f2, boolean z) {
        ...
        return r.a(viewParentD, this.c, f, f2, z);
    }
    ...
    public boolean a(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        ...
        r.a(viewParentD, this.c, i, i2, i3, i4, i5);
        if (iArr != null) {
            this.c.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i6;
            iArr[1] = iArr[1] - i7;
    ...
    public boolean a(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        r.a(viewParentD, this.c, i, i2, iArr, i3);
        if (iArr2 != null) {
            this.c.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i4;
            iArr2[1] = iArr2[1] - i5;
