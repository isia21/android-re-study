...
public class b {
        ...
        public View.AccessibilityDelegate a(final b bVar) {
            return new View.AccessibilityDelegate() { // from class: android.support.v4.g.b.a.1
                ...
                public AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
                    android.support.v4.g.a.b bVarA = bVar.a(view);
                    if (bVarA != null) {
                        return (AccessibilityNodeProvider) bVarA.a();
                    }
                    return null;
                }
    ...
    /* JADX INFO: renamed from: android.support.v4.g.b$b, reason: collision with other inner class name */
    static class C0008b {
        C0008b() {
        }
