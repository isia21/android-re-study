...
public class g implements android.arch.lifecycle.e, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public static g a(Context context, String str, Bundle bundle) {
        try {
            Class<?> clsLoadClass = V.get(str);
            if (clsLoadClass == null) {
                clsLoadClass = context.getClassLoader().loadClass(str);
                V.put(str, clsLoadClass);
            }
            g gVar = (g) clsLoadClass.getConstructor(new Class[0]).newInstance(new Object[0]);
            if (bundle != null) {
    ...
    static boolean a(Context context, String str) {
        try {
            ...
            return g.class.isAssignableFrom(clsLoadClass);
    ...
    public void a(Context context) {
        this.H = true;
        Activity activityF = this.t == null ? null : this.t.f();
        if (activityF != null) {
            this.H = false;
            a(activityF);
        }
    ...
    public LayoutInflater e(Bundle bundle) {
        ...
        LayoutInflater layoutInflaterB = this.t.b();
        i();
        android.support.v4.g.e.b(layoutInflaterB, this.u.w());
    ...
    void m(Bundle bundle) {
        ...
        j(bundle);
        if (this.u == null || (parcelableJ = this.u.j()) == null) {
            return;
        }
        bundle.putParcelable("android:support:fragments", parcelableJ);
    }
