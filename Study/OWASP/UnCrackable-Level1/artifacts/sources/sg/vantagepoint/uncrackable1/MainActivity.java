...
public class MainActivity extends Activity {
    ...
    private void ErrorMessageQuit(String str) {
    ...
    protected void onCreate(Bundle bundle) {
        if (Utils_Root.IsCanAccessSU() || Utils_Root.IsBuildTagsContain_TestKeys() || Utils_Root.IsCanFindRootJunk()) {
            ErrorMessageQuit("Root detected!");
        }
        if (Utils_Debug.IsDebug(getApplicationContext())) {
            ErrorMessageQuit("App is debuggable!");
        }
    ...
    public void verify(View view) {
        ...
        AlertDialog alertDialogCreate = new AlertDialog.Builder(this).create();
        if (AnswerVerifyer.IsStringCorrect(string)) {
